...
namespace MyGame.CraftingSystem
{
    public class CraftingManager : MonoBehaviour
    {
        ...
        private void CreatePotionRecipe()
        {
            ...
            recipe.AddRequiredMaterial(201, 2);           //Herb, 2
            recipe.AddRequiredMaterial(202, 1);           //Water, 1
            recipes.Add(recipe.recipeId, recipe);
        }
        ...
        public List<Recipe> GetAvailableRecipes()            //가능한 레시피를 리턴하는 함수
        {
